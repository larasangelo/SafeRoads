class LanguageConfig {
  static const Map<String, Map<String, String>> translations = {
    'en': {
      ...
      "routeCostMultiplier": "This route has a cost {x} times higher than the recommended route.",
      // Login
    ...
    'pt': {
      ...
      "routeCostMultiplier": "Esta rota tem um custo {x} vezes superior à rota recomendada.",
      // Login
      "start": "Iniciar",
    ...
    'es': {
      ...
      "routeCostMultiplier": "Esta ruta tiene un costo {x} veces superior a la ruta recomendada.",
      // Login
